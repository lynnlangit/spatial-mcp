...
Four interfaces for interacting with the precision medicine MCP server architecture:
- **[Streamlit App](streamlit-app/)** — Clinical chat interface for conversational analysis powered by Claude or Gemini. Also available in a [student version](streamlit-app-students/) with token guardrails.
