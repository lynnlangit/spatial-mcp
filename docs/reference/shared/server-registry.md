...
**Custom Servers:** 20 (116 tools) | **Production Ready:** 18 (90%) | **External Servers:** 6 (46 tools) | **Framework:** FastMCP ≥ 2.13
...
| **mcp-cardiometabolic** | 11 | 100% Real | Reynolds/Framingham/ASCVD risk scoring, biomarker panels, Lp(a), lipid pattern interpretation, FH clinical scoring (DLCN), PRS (PGS Catalog), APO CV risk, preventive reports | [README](../../../servers/mcp-cardiometabolic/README.md) |
