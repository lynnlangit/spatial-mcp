...
PatientTwo demonstrates cross-cancer portability of the platform — the same 19 servers and 104 tools used for HGSOC (PAT001) are applied to a completely different cancer type with **zero disease-specific code changes**.
