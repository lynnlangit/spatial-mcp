...
**Step 4 — Neoantigen Burden:** Estimate neoantigen burden for a HGSOC tumor with TMB = 47.3 mutations/Mb. Then score the antigen presentation pathway using the estimated neoantigen count.
