...
> 20 custom servers (116 tools). PAT003 (preventive CVD) validated April 23, 2026.
...
**Servers:** 20 custom (116 tools) + 6 external connectors — see [Server Registry](../reference/shared/server-registry.md) for current counts.
